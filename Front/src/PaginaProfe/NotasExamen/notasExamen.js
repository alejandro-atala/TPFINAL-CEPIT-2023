...
const NotasExamenesList = () => {
 ...
 useEffect(() => {
  ...
  const fetchAnios = async () => {
    try {
      const response = await axios.get('https://app-9d7fdcc2-2916-41fd-93f1-ef602d6afbcc.cleverapps.io/curso/anios');
  ...
  const fetchMaterias = async () => {
    try {
      const response = await axios.get('https://app-9d7fdcc2-2916-41fd-93f1-ef602d6afbcc.cleverapps.io/materias');
  ...
  const fetchAlumnosPorAnio = async (anio) => {
    try {
      ...
      const response = await axios.get(`https://app-9d7fdcc2-2916-41fd-93f1-ef602d6afbcc.cleverapps.io/alumno/por-anio/${anio}`);
  ...
  const saveNotasExamenes = async () => {
    ...
    const notasToSave = alumnos.map((alumno) => ({
      ...
      trimestre: '0', // Siempre asignamos '0' como trimestre
      materia: selectedMateria,
    }));
    console.log(notasToSave)
    try {
      await axios.post('https://app-9d7fdcc2-2916-41fd-93f1-ef602d6afbcc.cleverapps.io/notas-examenes', notasToSave, {
        headers: {
