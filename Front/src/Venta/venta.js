...
function Venta() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`https://app-2361a359-07df-48b8-acfd-5fb4c0536ce2.cleverapps.io/email/suscripcion`, formData);
        ...
        <p>VSA Desarrollos</p>
          <div className="row">
            ...
            <div className="col-md-6">
              <h1 className='h1-venta'>Gestion Integral para Escuelas</h1>
            ...
            <div className="col-md-6 carru mx-auto">
